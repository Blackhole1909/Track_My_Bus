...
public class driver_tracklocation extends AppCompatActivity implements OnMapReadyCallback
{
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent intent = new Intent(driver_tracklocation.this,MapsActivity.class);
    ...
    public void route_dialog()
    {
        ...
        String[] routes = {"(1) Dharmasthala Route ", "(2) Shiradi Route ", "(3) Charmadi Route","(4) College Route","(5) Naravi Route ","(6) Manglore Route "};
